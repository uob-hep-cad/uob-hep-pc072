Z90B IBIS Model
Die Rev "B"
4Gb DDR4 SDRAM IBIS Model
Rev 2.1: 4/4/2018

z90b.ibs is valid for Commercial Temperature Range 0C<=Tc<=95C
z90b_it.ibs is valid for Industrial Temperature Range -40C<=Tc<=95C
...
The *_2666 models are valid for all speed grades up to 2666 Mbps.
The *_3200 models are valid for the 3200 Mbps speed grades.
...
1. The on-die VDDQ-VSSQ decoupling circuit for DQ and DQS MUST be included 
   ...
   a. z90b_ondie_decoupling_all.ckt - includes VDDQ-VSSQ decoupling for all 
   ...
   b. z90b_ondie_decoupling_perdq.ckt - includes VDDQ-VSSQ decoupling for an 
	  ...
	  in parallel is equivalent to the z90b_ondie_decoupling_all.ckt circuit.
...
[Copyright]   Copyright 2018 Micron Technology, Inc. All rights reserved.
