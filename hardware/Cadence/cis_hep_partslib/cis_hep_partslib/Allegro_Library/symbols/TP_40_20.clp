...
(putprop _clp_cinfo (list (_clpAdjustPt -27.5:-45.83 _clp_cinfo)	
	(_clpAdjustPt 165.2:67.5 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(111.0 1469.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("PAD29" _clpAdjustPt(0:0 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("TP_40_20" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "TP*"
	(_clpAdjustPt 29:-35 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "TP*"
	(_clpAdjustPt 50:-20 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt 25:0 _clp_cinfo))
...
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 5.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 25:0 _clp_cinfo) nil
...
_clp_path  = (_clpPathStart (list (_clpAdjustPt -25:-25 _clp_cinfo))
