...
(putprop _clp_cinfo (list (_clpAdjustPt -133.33:-62.5 _clp_cinfo)	
	(_clpAdjustPt 61.5:62.5 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(383.0 1468.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("SC70-5" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
