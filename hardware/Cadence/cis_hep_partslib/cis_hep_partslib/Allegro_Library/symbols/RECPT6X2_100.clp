...
(putprop _clp_cinfo (list (_clpAdjustPt -125:-611.8 _clp_cinfo)	
	(_clpAdjustPt 225:100 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-2140.0 3765.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("RECPT6X2_100" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "12" 
	(_clpAdjustPt 210:-520 _clp_cinfo)  _clp_text_orient 
...
_clp_dbid = (_clpDBCreateText "1" 
	(_clpAdjustPt -75:0 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/ASSEMBLY_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "24" )
_clp_dbid = (_clpDBCreateText "11" 
	(_clpAdjustPt -50:-600 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/ASSEMBLY_TOP" _clp_sym)
...
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt 110:65 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "CENTER" nil _clp_cinfo->f_rotation + 0.000 "24" )
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt 0:60 _clp_cinfo)  _clp_text_orient 
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -50:-550 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 150:-550 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
