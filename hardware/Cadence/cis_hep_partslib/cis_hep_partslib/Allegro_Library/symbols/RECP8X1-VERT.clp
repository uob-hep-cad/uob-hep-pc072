...
(putprop _clp_cinfo (list (_clpAdjustPt -121.8:-159.5 _clp_cinfo)	
	(_clpAdjustPt 195:765 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(2100.0 3350.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:710 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:610 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:110 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:310 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:510 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:410 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(-5:210 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("70SQ_40P" _clpAdjustPt(-5:10 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("RECP8X1-VERT" "PACKAGE") _clpAdjustPt('(-5.0 10.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt -55:-100 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "CENTER" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt -110:80 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt 45:760 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -55:760 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -55:-40 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 45:-40 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 45:760 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
