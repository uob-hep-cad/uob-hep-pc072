...
(putprop _clp_cinfo (list (_clpAdjustPt -150:-850 _clp_cinfo)	
	(_clpAdjustPt 289:166.66 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-971.0 20.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-700 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-700 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-600 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-600 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-500 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-500 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-400 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-400 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-300 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-300 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-200 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-200 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:-100 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(0:-100 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR40D" _clpAdjustPt(100:0 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreatePin("PAD70SQ40D" _clpAdjustPt(0:0 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("HEADER_8X2" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "16" 
	(_clpAdjustPt 90:-795 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "15" 
	(_clpAdjustPt -30:-790 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "2" 
	(_clpAdjustPt 100:65 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "1" 
	(_clpAdjustPt -10:70 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "JP*"
	(_clpAdjustPt 168:-58 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "JP*"
	(_clpAdjustPt 55:-320 _clp_cinfo)  _clp_text_orient 
