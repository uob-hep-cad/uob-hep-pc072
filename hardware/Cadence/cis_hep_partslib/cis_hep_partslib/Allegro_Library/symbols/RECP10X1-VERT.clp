...
(putprop _clp_cinfo (list (_clpAdjustPt -131.8:-55 _clp_cinfo)	
	(_clpAdjustPt 200:955 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-600.0 3125.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:900 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("RECP10X1-VERT" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt -120:10 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "CENTER" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt -105:0 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt 50:950 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -50:950 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
...
_clp_path  = (_clpPathStart (list (_clpAdjustPt 50:750 _clp_cinfo))
