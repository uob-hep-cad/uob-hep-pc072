...
(putprop _clp_cinfo (list (_clpAdjustPt -155:-138.33 _clp_cinfo)	
	(_clpAdjustPt 122.5:67.5 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-120.0 1715.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("PAD70CIR30D" _clpAdjustPt(0:0 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreatePin("PAD70CIR30D" _clpAdjustPt(-100:0 _clp_cinfo) 	
	_clp_pin_text (180.000 + _clp_cinfo->f_rotation)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("CAP100" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "C*"
	(_clpAdjustPt 60:-9 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 0.000 "1" )
_clp_dbid = (_clpDBCreateText "C*"
	(_clpAdjustPt -70:-14 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt -10:62.5 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -90:62.5 _clp_cinfo))
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -150:2.5 _clp_cinfo) nil
 	(_clpAdjustPt -90:2.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -150:-2.5 _clp_cinfo))
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -90:-62.5 _clp_cinfo) nil
 	(_clpAdjustPt -90:-2.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -10:-62.5 _clp_cinfo))
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 50:-2.5 _clp_cinfo) nil
 	(_clpAdjustPt -10:-2.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 50:2.5 _clp_cinfo))
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -10:62.5 _clp_cinfo) nil
 	(_clpAdjustPt -10:2.5 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
...
_clp_path  = (_clpPathStart (list (_clpAdjustPt 50:62.5 _clp_cinfo))
	(_clpMKSConvert 10.000000 _clp_cinfo->t_from_units _clp_cinfo->t_to_units))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -150:62.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -150:-62.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 50:-62.5 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 10.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 50:62.5 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
