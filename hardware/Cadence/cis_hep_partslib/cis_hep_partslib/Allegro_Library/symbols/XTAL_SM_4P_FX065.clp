...
(putprop _clp_cinfo (list (_clpAdjustPt -134:-131.89 _clp_cinfo)	
	(_clpAdjustPt 72.9:131.89 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-948.0 1350.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("PAD13" _clpAdjustPt(43.30999999999995:-90.54999999999996 _clp_cinfo) 	
	_clp_pin_text (90.000 + _clp_cinfo->f_rotation)
	(_clpConvertPt -90.55:-43.31 _clp_cinfo) 0.000 _clp_pbuf _clp_sym _clpIsLayout() nil)
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("XTAL_SM_4P_FX065" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
_clp_dbid = (_clpDBCreateText "U*"
	(_clpAdjustPt -126:-16 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 90.000 "1" )
_clp_dbid = (_clpDBCreateText "U*"
	(_clpAdjustPt 15:-30 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt -9.840000000000032:0 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 8.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 9.840000000000032:0 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
_clp_dbid = _clpDBCreatePath(_clp_path "PACKAGE GEOMETRY/SILKSCREEN_TOP" 'line _clp_sym _clpPl)
_clpPl = nil

_clp_path  = (_clpPathStart (list (_clpAdjustPt 0:-9.839999999999918 _clp_cinfo))
	(_clpMKSConvert 8.000000 _clp_cinfo->t_from_units _clp_cinfo->t_to_units))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 8.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 0:9.839999999999918 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
_clp_dbid = _clpDBCreatePath(_clp_path "PACKAGE GEOMETRY/SILKSCREEN_TOP" 'line _clp_sym _clpPl)
_clpPl = nil

_clp_path  = (_clpPathStart (list (_clpAdjustPt -68.89999999999998:-19.69000000000006 _clp_cinfo))
	(_clpMKSConvert 8.000000 _clp_cinfo->t_from_units _clp_cinfo->t_to_units))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 8.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -68.89999999999998:19.69000000000006 _clp_cinfo))
_clpPl = list(
	list("CLIP_DRAWING" _clp_clip_prop_value))
_clp_dbid = _clpDBCreatePath(_clp_path "PACKAGE GEOMETRY/SILKSCREEN_TOP" 'line _clp_sym _clpPl)
_clpPl = nil
...
_clp_path  = (_clpPathStart (list (_clpAdjustPt 68.89999999999998:-131.8900000000001 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -68.89999999999998:-131.8900000000001 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -68.89999999999998:131.8900000000001 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 68.89999999999998:131.8900000000001 _clp_cinfo))
