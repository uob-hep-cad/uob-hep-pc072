...
(putprop _clp_cinfo (list (_clpAdjustPt -125:-917.5 _clp_cinfo)	
	(_clpAdjustPt 225:181 _clp_cinfo)) 'l_extents)
(putprop _clp_cinfo (_clpAdjustPt '(-1410.0 3985.0) _clp_cinfo) 'l_zeropt)
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-800 _clp_cinfo) 	
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-800 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-700 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-700 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-600 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-600 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-500 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-500 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-400 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-400 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-300 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-300 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-200 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-200 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:-100 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(0:-100 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70RD_40P" _clpAdjustPt(100:0 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreatePin("70SQ_40P" _clpAdjustPt(0:0 _clp_cinfo) 	
	_clp_pin_text _clp_cinfo->f_rotation
...
_clp_dbid = _clpDBCreateSymbolSkeleton('("RECEPT_9X2_100MI" "PACKAGE") _clpAdjustPt('(0.0 0.0) _clp_cinfo)
...
(when (nequal _clp_sym  -1)
 t )
(_clpInitTextOrientation _clp_text_orient "RIGHT" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "2" 
	(_clpAdjustPt 100:95 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/ASSEMBLY_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "RIGHT" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "18" 
	(_clpAdjustPt 190:-915 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "1" 
	(_clpAdjustPt 0:115 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/ASSEMBLY_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "LEFT" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "17" 
	(_clpAdjustPt -60:-855 _clp_cinfo)  _clp_text_orient 
	"PACKAGE GEOMETRY/ASSEMBLY_TOP" _clp_sym)
...
(_clpInitTextOrientation _clp_text_orient "CENTER" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt 130:150 _clp_cinfo)  _clp_text_orient 
	"REF DES/SILKSCREEN_TOP" _clp_sym)

(_clpInitTextOrientation _clp_text_orient "CENTER" nil _clp_cinfo->f_rotation + 270.000 "24" )
_clp_dbid = (_clpDBCreateText "J*"
	(_clpAdjustPt 145:100 _clp_cinfo)  _clp_text_orient 
	"REF DES/ASSEMBLY_TOP" _clp_sym)

_clp_path  = (_clpPathStart (list (_clpAdjustPt 150:50 _clp_cinfo))
...
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -50:-850 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 150:-850 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
...
_clp_path  = (_clpPathStart (list (_clpAdjustPt -50:50 _clp_cinfo))
	(_clpMKSConvert 0.000000 _clp_cinfo->t_from_units _clp_cinfo->t_to_units))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt -50:-850 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
